...
$phonePage = function(){
	global $allPhones;
	?><div class="table"><table class="query"><? $allPhones(); ?></table></div><?
};
...
$updatePage = function(){
	global $allUpdates;
	?><div class="table"><? $allUpdates(); ?></div><?
};
		...
		<div class="box">
			<table class="header">
				<tr>
					...
					<td><a href="?view=phone">PhoneBook</a></td>
					<td><a href="?view=log">Log</a></td>
					<td><a href="?view=update">Updates</a></td>
				</tr>
			</table>
			<? $page(); ?>
		</div>
